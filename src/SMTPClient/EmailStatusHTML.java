...
public class EmailStatusHTML {
	...
	public static String spitHTML(List<Email> emailList) {
		...
		htmlData.append("<tr align = center><td>From</td<td>To</td><td>Subject</td><td>Sent Time</td><td>Delivery Time</td><td>Status</td></tr>");
		for (Email email : emailList) {
			
			htmlData.append("<tr><td>"+email.get_from()+"</td><td>"+email.get_to()+"</td><td>"+email.get_subject()+"</td><td>"+email.getSubmissionTimeString()+"</td><td>"+email.getDeliveryTimeString()+"</td><td>"+email.get_deliveryStatus()+"</td></tr>");
